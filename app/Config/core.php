 ...
 */
	Configure::write('Security.salt', 'ASkdfsia5448efdsf4515eRffh544eesfdfeed78754Fas4i');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '4845487844646546456465464987484488787');
